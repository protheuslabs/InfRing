...
- generated_at: 2026-06-11T06:48:55.276Z
...
- `runtime_behavior`: needs_probe (0.69/0.70)
...
- `authority_map`: needs_probe (0.55/0.80)
...
- `confidence`: needs_probe (0.66/0.75)
