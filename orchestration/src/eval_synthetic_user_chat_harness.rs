...
const USER_TERM_STOPWORDS: &[&str] = &[
    "about", "after", "again", "answer", "because", "before", "current", "directly", "does",
    "from", "give", "have", "into", "just", "like", "only", "please", "query", "request", "same",
    "search", "some", "tell", "that", "their", "them", "then", "there", "this", "turn", "what",
