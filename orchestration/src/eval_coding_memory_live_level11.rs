...
pub struct LiveLevel11JudgeReport {
    ...
    pub timing: LiveLevel11TimingSummary,
...
pub struct LiveLevel11AttemptJudge {
    pub attempt_id: String,
    pub ok: bool,
    pub timing: LiveLevel11AttemptTiming,
    pub checks: Vec<LiveLevel11Check>,
    pub failures: Vec<String>,
}

#[derive(Debug, Clone, Serialize)]
pub struct LiveLevel11TimingSummary {
...
#[derive(Debug, Clone, Serialize)]
pub struct LiveLevel11AttemptTiming {
...
pub fn judge_live_level11_batch(batch_root: &Path) -> LiveLevel11JudgeReport {
    ...
    let timing = summarize_level11_timing(batch_started_at_unix_ms, judged_at_unix_ms, &attempts);
...
fn summarize_level11_timing(
    batch_started_at_unix_ms: Option<u128>,
    judged_at_unix_ms: u128,
    attempts: &[LiveLevel11AttemptJudge],
) -> LiveLevel11TimingSummary {
